    ...
    private function articles(): array
    {
        return [
            ...
            [
                ...
                'excerpt' => 'First-time + recurring across everything your owners do — subscriptions, rent, marketplace, screening, agreements and financing — not just their plan.',
                'body' => '<h3>Two types, on every line</h3><p>You earn two ways: a <strong>first-time commission</strong> the first time an owner does something, and a <strong>recurring commission</strong> — a share for the months that follow. What changed is the <em>scope</em>: this now applies across <strong>everything your owners do on the platform</strong>, not just their plan fee:</p><ul><li><strong>Subscriptions</strong> — when a referred owner converts to a paying plan, and on their ongoing payments.</li><li><strong>Rent</strong> — a small share of the rent your owners collect through the platform.</li><li><strong>Marketplace</strong> — a cut of our commission when owners sell to their tenants.</li><li><strong>Tenant screening</strong> — when an owner runs a paid tenant check.</li><li><strong>Agreements</strong> — when an owner sends a paid e-sign lease.</li><li><strong>Financing</strong> — when an owner you introduced takes infrastructure financing.</li></ul><h3>Why this matters to you</h3><p>Even an owner on the <strong>free</strong> plan earns you money every time they screen a tenant, send an agreement, or take financing. You’re paid for the <strong>activity you bring</strong>, not just the plan they sit on — so help your owners get value and stay active. Your dashboard shows <em>“what your owners generated for you this month”</em>, broken down by line.</p><h3>Your balance</h3><p>All of it accrues to your balance under <strong>Commissions</strong>, where you can see each event and its status and withdraw to M-Pesa. Rates are configured by Centresidence and shown in your dashboard.</p>',
            ],
            [
