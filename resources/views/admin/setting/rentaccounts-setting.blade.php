                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-lg-12 col-xl-8 col-xxl-9">
                            <div class="account-settings-rightside bg-off-white theme-border radius-4 p-25">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-8">
                                            ...
                                            <p class="text-muted mb-0" style="font-size:13px;">
                                                {{ __('Configure the Mpesa account that will receive all transaction package rent payments. Commission deductions and owner wallet credits are processed through this account.') }}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <form action="{{ route('admin.setting.rentaccounts.setting.save') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="mkt-setting-card">
                                        ...
                                        <div class="mkt-setting-card__body">
                                            @php
                                                ...
                                                $current  = getOption('centresidence_rent_mpesa_account_id');
                                            @endphp
                                            ...
                                            @else
                                                ...
                                                <div class="mkt-account-grid" id="accountGrid">
                                                    @foreach($accounts as $account)
                                                        ...
                                                        <label class="mkt-account-option {{ $isSelected ? 'mkt-account-option--selected' : '' }}"
                                                            ...
                                                            <input type="radio"
                                                                   name="centresidence_rent_mpesa_account_id"
                                                ...
                                                @if($current)
                                                    <p class="mkt-current-note">
                                                        ...
                                                        {{ __('Currently active. All new marketplace payments will route through the selected account.') }}
                                                    </p>
                                                @endif
                                            @endif
                                        </div>
