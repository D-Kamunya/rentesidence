<style>
    ...
    /* ── Section list ────────────────────────────────────── */
    .dp-section-list { border-top: 0.5px solid #e5e7eb; }
    .dp-section-row {
        display: flex;
        align-items: center;
    ...
    .dp-section-row:last-child { border-bottom: none; }
    .dp-section-row:hover { background: #fafafa; }
    .dp-section-row--editing { background: #EEF5FD; border-left: 3px solid #185FA5; }

    .dp-section-row__left {
        display: flex;
    ...
    .dp-section-row__title {
        font-size: 13px;
        font-weight: 500;
        color: #111827;
        margin: 0 0 3px;
    }
    .dp-section-row__preview {
        font-size: 12px;
        color: #9ca3af;
        margin: 0;
        white-space: nowrap;
    ...
    .dp-status-badge--active   { background: #E1F5EE; color: #0F6E56; }
    .dp-status-badge--inactive { background: #f3f4f6; color: #9ca3af; }

    /* ── Toggle switch ───────────────────────────────────── */
    .dp-toggle { display: inline-flex; align-items: center; cursor: pointer; margin-top: 6px; }
    ...
    .dp-toggle input:checked + .dp-toggle__track { background: #1D9E75; }
    .dp-toggle input:checked + .dp-toggle__track::after { transform: translateX(16px); }
</style>