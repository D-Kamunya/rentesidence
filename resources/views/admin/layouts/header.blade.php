    ...
    <div class="navbar-header">
        <div class="d-flex">
            <div class="navbar-brand-box">
                @include('common.layouts._brand', ['brandHref' => route('admin.dashboard')])
            </div>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block user-dropdown">
                ...
                <div class="dropdown-menu {{ selectedLanguage()->rtl == 1 ? 'dropdown-menu-start' : 'dropdown-menu-end' }}"
                    ...
                    <a class="dropdown-item" href="{{ route('admin.wallet.commissions') }}"><i
                            class="ri-wallet-3-line align-middle me-1"></i> {{ __('Wallet') }}</a>
