                ...
                <div class="prop-page-header mb-4">
                    <div>
                        <h2 class="prop-page-title">
                            {{ @$pageTitle }}
                            <span class="prop-count-badge">{{ $propertiesCount }}</span>
                        </h2>
...
/* Thumbnail */
.prop-card__img-wrap {
    display:block; overflow:hidden; height:160px; flex-shrink:0;
}
.prop-card__img {
...
.prop-card__address {
    ...
    font-size:12px; color:var(--gray-500); margin-bottom:12px; line-height:1.4;
}
...
.prop-stat__value { font-size:14px; font-weight:600; color:var(--gray-800); }
.prop-stat__value--green { color:var(--green); }

/* Footer */
.prop-card__footer {
    border-top:0.5px solid var(--gray-200); background:var(--gray-50);
}
.prop-card__cta {
    display:flex; align-items:center; justify-content:center; gap:5px;
    width:100%; padding:10px; font-size:12px; font-weight:500;
    color:var(--blue); text-decoration:none; transition:background .15s, color .15s;
}
.prop-card__cta:hover { background:var(--blue); color:var(--white); }
