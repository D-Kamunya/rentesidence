    ...
    <main class="main">
        <div class="card">
            ...
            <div class="card-banner">
                ...
                <h1 class="banner-title">Your affiliate account has been <em>temporarily suspended.</em></h1>
                <p class="banner-sub">Access to your affiliate dashboard is restricted. Our team can help you resolve this and get back to work quickly.</p>
            </div>
            ...
            <div class="card-body">
                ...
                <div class="info-block">
                    ...
                    <div class="info-row">
                        ...
                        <div class="info-text">
                            ...
                            <span>You cannot work leads, view commissions, or access marketing tools while suspended.</span>
                        </div>
                    </div>
                    ...
                    <div class="info-row">
                        ...
                        <div class="info-text">
                            <strong>Lead activity paused</strong>
                            <span>Your leads and referred accounts stay attributed to you — only your access is restricted.</span>
                        </div>
                    </div>
                    ...
                    <div class="info-row">
                        ...
                        <div class="info-text">
                            <strong>Your earnings are safe</strong>
                            <span>All earned commissions, referrals and history are preserved and intact.</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="contact-grid">
                    <a href="mailto:info@centresidence.com" class="contact-tile">
                        <div class="tile-icon">
                    ...
                    <a href="tel:+254714389005" class="contact-tile">
                        <div class="tile-icon">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <a href="mailto:info@centresidence.com?subject=Affiliate Account Suspension — Requesting Review&body=Hello Centresidence Team,%0A%0AMy affiliate account has been suspended and I would like to request a review.%0A%0AName: {{ Auth::user()->name ?? '' }}%0AEmail: {{ Auth::user()->email ?? '' }}%0A%0APlease advise on next steps.%0A%0AThank you."
                   class="cta-email">
