                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td style="color:#444; font-weight: 400;">
                                                                            ...
                                                                            <br>
                                                                            <span
                                                                                style="font-weight:bold;">{{ __('Payment Method') }}:
                                                                                &nbsp;</span>
                                                                            <span
                                                                                style="font-weight:lighter;">{{ Str::ucfirst($content['method']) }}
                                                                            </span>
                                                                            <br>
                                                                            <span
                                                                                style="font-weight:bold;">{{ __('Payment Amount') }}:
                                                                                &nbsp;</span>
                                                                            <span
                                                                            ...
                                                                            <br>
                                                                            <span
                                                                                style="font-weight:bold;">{{ __('Payment Status') }}:
                                                                                &nbsp;</span>
                                                                            <span
