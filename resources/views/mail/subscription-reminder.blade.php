                                    ...
                                    <td align="center" valign="top">
                                        ...
                                        <table bgcolor="#fff" cellpadding="0" cellspacing="0"
                                            ...
                                            <tbody style="margin-top: 15px;">
                                                ...
                                                <tr>
                                                    <td class="headline">{{ $content['title'] }}</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <center>
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td style="color:#444; font-weight: 400;">
                                                                            ...
                                                                            <br>
                                                                            <span
                                                                                style="font-weight:bold;">{{ __('Plan') }}:
                                                                                &nbsp;</span>
                                                                            <span
                                                                                style="font-weight:lighter;">{{ Str::ucfirst($content['subscription']->name) }}
                                                                            </span>
                                                                            <br>
                                                                            <span
                                                                                style="font-weight:bold;">{{ __('Monthly Amount') }}:
                                                                                &nbsp;</span>
                                                                            <span
                                                                                style="font-weight:lighter;">{{ currencyPrice($content['subscription']->monthly_price) }}
                                                                            </span>
                                                                            <br>
                                                                            <span
                                                                                style="font-weight:bold;">{{ __('Yearly Amount') }}:
                                                                                &nbsp;</span>
                                                                            <span
                                                                                style="font-weight:lighter;">{{ currencyPrice($content['subscription']->yearly_price) }}
                                                                            </span>
                                                                            <br>
                                                                            <span
                                                                                style="font-weight:bold;">{{ __('Expiry Date') }}:
                                                                                &nbsp;</span>
                                                                            <span
                                                                                style="font-weight:lighter;">{{ \Carbon\Carbon::parse($content['subscription']->end_date)->format('d M Y') }}
                                                                            </span>
                                                                            <br>
                                                                            <span
                                                                            ...
                                                                            <span
                                                                                ...
                                                                                @if(\Carbon\Carbon::parse($content['subscription']->end_date)->isPast())
                                                    ...
                                                    <td>
                                                        <div>
                                                            <a style="background-color:#3686FC;border-radius:4px;color:#fff;display:inline-block;font-family:Helvetica, Arial, sans-serif;font-size:18px;font-weight:normal;line-height:50px;text-align:center;text-decoration:none;width:350px;-webkit-text-size-adjust:none;"
                                                                href="{{ route('owner.subscription.index', ['current_plan' => 'no']) }}">{{ __('RENEW SUBSCRIPTION') }}</a>
                                                        </div>
                                                        <br>
                                                    </td>
                                                </tr>
