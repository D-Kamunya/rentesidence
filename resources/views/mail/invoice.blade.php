                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td style="color:#444; font-weight: 400;">
                                                                            ...
                                                                            <br>
                                                                            <span
                                                                                style="font-weight:bold;">{{ __('Amount') }}:
                                                                                &nbsp;</span>
                                                                            <span
                                                                                style="font-weight:lighter;">{{ currencyPrice($content['amount']) }}
                                                                            </span>
                                                                            <br>
                                                                            <span
                                                                                style="font-weight:bold;">{{ __('Invoice no') }}:
                                                                                &nbsp;</span>
                                                                            <span
                                                                                style="font-weight:lighter;">{{ $content['invoiceNo'] }}
                                                                            </span>
                                                                            <br>
                                                                            <span
                                                                            ...
                                                                            <br>
                                                                            <span
                                                                                style="font-weight:bold;">{{ __('Due date') }}:
                                                                                &nbsp;</span>
                                                                            <span
                                                                                style="font-weight:lighter;">{{ $content['dueDate'] }}
                                                                            </span>
                                                                            <br>
                                                                            <span
                                                                                style="font-weight:bold;">{{ __('Month') }}:
                                                                                &nbsp;</span>
                                                                            <span
                                                                                style="font-weight:lighter;">{{ $content['month'] }}
                                                                            </span>
                                                                            <br>
                                                                            <br>
                                                                            <br>
