...
class LanguageController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('owner.language.index', $data);
    }
    ...
    public function delete($id)
    {
        ...
        $language->delete();
        return redirect()->route('owner.language.index')->with('success', __('Deleted Successfully.'));
    }
    ...
    public function translateLanguage($id)
    {
        ...
        return view('owner.language.translate', $data);
    }
