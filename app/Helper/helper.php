...
if (!function_exists('sendInvoiceNotificationAndEmail')) {
    function sendInvoiceNotificationAndEmail($invoice, $tenant){
        $title = __("You have a new invoice");
        $body = __("Please check the invoice and response as soon as possible.");
        addNotification($title, $body, null, null, $tenant->id, $invoice->owner_user_id);
