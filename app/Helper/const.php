...
const PROPERTY_AMENITY_CINEMA = 3;
const PROPERTY_AMENITY_GARAGE = 4;
const PROPERTY_AMENITY_SWIMMING_POOL = 5;
const PROPERTY_AMENITY_SECURITY = 6;
const PROPERTY_AMENITY_ECO_FRIENDLY_ENERGY = 7;
const PROPERTY_AMENITY_WI_FI = 8;
const PROPERTY_AMENITY_PARKING = 9;
const PROPERTY_AMENITY_BALCONY = 10;
const PROPERTY_AMENITY_GARDEN = 11;
const PROPERTY_AMENITY_LAUNDRY_ROOM = 12;
const PROPERTY_AMENITY_AIR_CONDITIONING = 13;
const PROPERTY_AMENITY_CENTRAL_HEATING = 14;
const PROPERTY_AMENITY_FITNESS_CENTER = 15;
const PROPERTY_AMENITY_SPA = 16;
...
const SUBSCRIPTION_REMAINDER_STATUS_ACTIVE = 1;
const SUBSCRIPTION_REMAINDER_STATUS_DEACTIVATE = 0;

const SUBSCRIPTION_REMAINDER_EVERYDAY_STATUS_ACTIVE = 1;
const SUBSCRIPTION_REMAINDER_EVERYDAY_STATUS_DEACTIVATE = 0;
...
const APPLICATION_SENT_SUCCESSFULLY = "Application sent Successfully";
...
const AFFILIATE_STATUS_ACTIVE = 1;
const AFFILIATE_STATUS_INACTIVE = 2;
const AFFILIATE_STATUS_DRAFT = 3;
const AFFILIATE_STATUS_CLOSE = 4;
...
const EMAIL_TEMPLATE_SUBSCRIPTION_REMINDER= 11;
const EMAIL_TEMPLATE_APPLICATION_REJECTED = 12;
const EMAIL_TEMPLATE_TENANT_ASSIGNED = 13;
